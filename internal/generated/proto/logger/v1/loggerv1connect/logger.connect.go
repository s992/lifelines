...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/s992/logger/internal/generated/proto/logger/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	TagServiceName = "logger.v1.TagService"
	// LogLineServiceName is the fully-qualified name of the LogLineService service.
	LogLineServiceName = "logger.v1.LogLineService"
)
...
const (
	...
	TagServiceListTagsProcedure = "/logger.v1.TagService/ListTags"
	// TagServiceSearchTagsProcedure is the fully-qualified name of the TagService's SearchTags RPC.
	TagServiceSearchTagsProcedure = "/logger.v1.TagService/SearchTags"
	// TagServiceCreateTagProcedure is the fully-qualified name of the TagService's CreateTag RPC.
	TagServiceCreateTagProcedure = "/logger.v1.TagService/CreateTag"
	// LogLineServiceListLogLinesProcedure is the fully-qualified name of the LogLineService's
	// ListLogLines RPC.
	LogLineServiceListLogLinesProcedure = "/logger.v1.LogLineService/ListLogLines"
	// LogLineServiceCreateLogLineProcedure is the fully-qualified name of the LogLineService's
	// CreateLogLine RPC.
	LogLineServiceCreateLogLineProcedure = "/logger.v1.LogLineService/CreateLogLine"
)

// TagServiceClient is a client for the logger.v1.TagService service.
...
// NewTagServiceClient constructs a client for the logger.v1.TagService service. By default, it uses
...
// ListTags calls logger.v1.TagService.ListTags.
...
// SearchTags calls logger.v1.TagService.SearchTags.
...
// CreateTag calls logger.v1.TagService.CreateTag.
...
// TagServiceHandler is an implementation of the logger.v1.TagService service.
...
func NewTagServiceHandler(svc TagServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/logger.v1.TagService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTagServiceHandler) ListTags(context.Context, *connect.Request[v1.ListTagsRequest]) (*connect.Response[v1.ListTagsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logger.v1.TagService.ListTags is not implemented"))
}
...
func (UnimplementedTagServiceHandler) SearchTags(context.Context, *connect.Request[v1.SearchTagsRequest]) (*connect.Response[v1.SearchTagsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logger.v1.TagService.SearchTags is not implemented"))
}
...
func (UnimplementedTagServiceHandler) CreateTag(context.Context, *connect.Request[v1.CreateTagRequest]) (*connect.Response[v1.CreateTagResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logger.v1.TagService.CreateTag is not implemented"))
}

// LogLineServiceClient is a client for the logger.v1.LogLineService service.
...
// NewLogLineServiceClient constructs a client for the logger.v1.LogLineService service. By default,
...
// ListLogLines calls logger.v1.LogLineService.ListLogLines.
...
// CreateLogLine calls logger.v1.LogLineService.CreateLogLine.
...
// LogLineServiceHandler is an implementation of the logger.v1.LogLineService service.
...
func NewLogLineServiceHandler(svc LogLineServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/logger.v1.LogLineService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedLogLineServiceHandler) ListLogLines(context.Context, *connect.Request[v1.ListLogLinesRequest]) (*connect.Response[v1.ListLogLinesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logger.v1.LogLineService.ListLogLines is not implemented"))
}
...
func (UnimplementedLogLineServiceHandler) CreateLogLine(context.Context, *connect.Request[v1.CreateLogLineRequest]) (*connect.Response[v1.CreateLogLineResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("logger.v1.LogLineService.CreateLogLine is not implemented"))
}
